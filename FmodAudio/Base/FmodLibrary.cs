...
[NativeVTable(MethodNamePrefix = "FMOD_")]
public unsafe sealed partial class FmodLibrary
{
    #region Global Functions
    /// <summary>
    /// Specifies a method for FMOD to allocate memory, either through user supplied callbacks or through a user supplied memory buffer with a fixed size.
    /// </summary>
    /// <param name="poolmem">
    /// Block of memory of size poollen bytes for FMOD to manage, mutually exclusive with <paramref name="useralloc"/> / <paramref name="userrealloc"/> / <paramref name="userfree"/>.
    /// </param>
    /// <param name="poollen">
    /// Size of <paramref name="poolmem"/>, must be a multiple of 512.
    /// </param>
    /// <param name="useralloc">
    /// Memory allocation callback compatible with ANSI malloc, mutually exclusive with <paramref name="poolmem"/>.
    /// [see <see cref="MemoryAllocCallback"/>]
    /// </param>
    /// <param name="userrealloc">
    /// Memory reallocation callback compatible with ANSI realloc, mutually exclusive with <paramref name="poolmem"/>.
    /// [see <see cref="MemoryReallocCallback"/>]
    /// </param>
    /// <param name="userfree">
    /// Memory free callback compatible with ANSI free, mutually exclusive with <paramref name="poolmem"/>.
    /// [see <see cref="MemoryFreeCallback"/>]
    /// </param>
    ...
    /// </remarks>
    [InteropMethod]
    public partial Result Memory_Initialize(
        void* poolmem,
        int poollen,
        delegate* unmanaged<uint, MemoryType, byte*, void*> useralloc,
        delegate* unmanaged<void*, uint, MemoryType, byte*, void*> userrealloc,
        delegate* unmanaged<void*, MemoryType, byte*, void> userfree,
    ...
    /// 
    /// Note that if using <see cref="Memory_Initialize"/>, the memory usage will be slightly higher than without it, as FMOD has to have a small amount of memory overhead to manage the available memory.
    /// </remarks>
    [InteropMethod]
    ...
    /// </summary>
    /// <param name="type">
    /// Identifier for an FMOD thread.
    /// </param>
    /// <param name="threadAffinity">
    /// Bitfield of desired CPU cores to assign the given thread to.
    /// </param>
    /// <param name="priority">
    /// Scheduling priority to assign the given thread to.
    /// </param>
    /// <param name="stackSize">
    /// Amount of stack space available to the given thread.
    /// </param>
    /// <remarks>
    ...
    /// </remarks>
    [InteropMethod(Guard = true)]
    public partial Result Thread_SetAttributes(FmodThreadType type, ulong threadAffinity, int priority, uint stackSize);
    #endregion
    ...
    public partial Result System_SetFileSystem(SystemHandle system,
        delegate* unmanaged<byte*, uint*, nint*, nint, Result> useropen,
        delegate* unmanaged<nint, nint, Result> userclose,
        delegate* unmanaged<nint, byte*, uint, uint*, nint, Result> userread,
        delegate* unmanaged<nint, uint, nint, Result> userseek,
        delegate* unmanaged<AsyncReadInfo*, nint, Result> userasyncread,
        delegate* unmanaged<AsyncReadInfo*, nint, Result> userasynccancel,
        int blockalign);
    ...
    [InteropMethod]
    public partial Result System_SetCallback(SystemHandle system, delegate* unmanaged<nint, SystemCallbackType, nint, nint, nint, Result> callback, SystemCallbackType callbackmask);
    ...
    [InteropMethod]
    public partial Result System_Init(SystemHandle system, int maxchannels, InitFlags flags, nint extradriverdata);
    ...
    [InteropMethod]
    public partial Result System_Set3DRolloffCallback(SystemHandle system, delegate* unmanaged<nint, float, float> callback);
    ...
    [InteropMethod]
    public partial Result System_GetOutputHandle(SystemHandle system, nint* handle);

    public Result System_GetOutputHandle(SystemHandle system, out nint handle)
    {
    ...
    [InteropMethod]
    internal partial Result System_SetUserData(SystemHandle system, nint userdata);

    [InteropMethod]
    internal partial Result System_GetUserData(SystemHandle system, nint* userdata);
    #endregion
    ...
    [InteropMethod]
    public partial Result Sound_Lock(SoundHandle sound, uint offset, uint length, nint* ptr1, nint* ptr2, uint* len1, uint* len2);

    public Result Sound_Lock(SoundHandle sound, uint offset, uint length, out nint ptr1, out nint ptr2, out uint len1, out uint len2)
    {
        fixed (nint* p1 = &ptr1, p2 = &ptr2)
    ...
    [InteropMethod]
    public partial Result Sound_Unlock(SoundHandle sound, nint ptr1, nint ptr2, uint len1, uint len2);
    ...
    [InteropMethod]
    public partial Result Sound_GetUserData(SoundHandle sound, nint* userdata);

    [InteropMethod]
    public partial Result Sound_SetUserData(SoundHandle sound, nint userdata);
    ...
    [InteropMethod]
    internal partial Result SoundGroup_SetUserData(SoundGroupHandle soundgroup, nint userdata);

    [InteropMethod]
    internal partial Result SoundGroup_GetUserData(SoundGroupHandle soundgroup, nint* userdata);
    #endregion
    ...
    [InteropMethod]
    public partial Result ChannelGroup_SetCallback(ChannelGroupHandle channelGroup, delegate* unmanaged<nint, ChannelControlType, ChannelControlCallbackType, void*, void*, void> callback);

    [InteropMethod]
    public partial Result Channel_SetCallback(ChannelHandle channel, delegate* unmanaged<nint, ChannelControlType, ChannelControlCallbackType, void*, void*, void> callback);
    ...
    [InteropMethod]
    public partial Result Channel_GetUserData(ChannelHandle channel, nint* userData);

    [InteropMethod]
    public partial Result Channel_SetUserData(ChannelHandle channel, nint userData);
    ...
    [InteropMethod]
    internal partial Result ChannelGroup_SetUserData(ChannelGroupHandle channelgroup, nint userdata);

    [InteropMethod]
    internal partial Result ChannelGroup_GetUserData(ChannelGroupHandle channelgroup, nint* userdata);
    ...
    [InteropMethod(Guard = true)]
    public partial Result DSP_SetCallback(DspHandle dsp, delegate* unmanaged<nint, DSPCallbackType, void*, Result> callback);
    ...
    [InteropMethod]
    public partial Result DSP_ShowConfigDialog(DspHandle dsp, nint hwnd, bool show);
    ...
    [InteropMethod]
    internal partial Result DSP_SetUserData(DspHandle dsp, nint userdata);

    [InteropMethod]
    internal partial Result DSP_GetUserData(DspHandle dsp, nint* userdata);
    ...
    [InteropMethod]
    internal partial Result DSPConnection_SetUserData(DspConnectionHandle dspconnection, nint userdata);

    [InteropMethod]
    internal partial Result DSPConnection_GetUserData(DspConnectionHandle dspconnection, nint* userdata);
    ...
    [InteropMethod]
    internal partial Result Geometry_SetUserData(GeometryHandle geometry, nint userdata);

    [InteropMethod]
    internal partial Result Geometry_GetUserData(GeometryHandle geometry, nint* userdata);
    ...
    [InteropMethod]
    internal partial Result Reverb3D_SetUserData(Reverb3DHandle reverb3D, nint userdata);

    [InteropMethod]
    internal partial Result Reverb3D_GetUserData(Reverb3DHandle reverb3D, nint* userdata);
