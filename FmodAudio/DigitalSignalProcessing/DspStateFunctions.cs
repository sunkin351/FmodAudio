...
{
    public readonly delegate* unmanaged<uint, MemoryType, nint, nint> Alloc;
    public readonly delegate* unmanaged<nint, uint, MemoryType, nint, nint> Realloc;
    public readonly delegate* unmanaged<nint, MemoryType, nint, void> Free;
    ...
    internal readonly delegate* unmanaged<DspState*, nint*, Result> GetUserData;
}
