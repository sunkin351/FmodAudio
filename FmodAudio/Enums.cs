...
public enum InitFlags : uint
{
    ...
    /// <summary>
    /// Enables hard clipping of output values greater than 1.0f or less then -1.0f.
    /// </summary>
...
public enum OutputType : int
{
    ...
    /// <summary>
    /// Win / WinStore / Xbox One / Game Core | Windows Audio Session API | Default on Windows Vista and above, Xbox One and Windows Store Applications
    /// </summary>
    WASAPI,
    ...
    /// <summary>
    /// Win10 / XboxOne / Game Core | Windows Sonic
    /// </summary>
    WINSonic,
    ...
    /// <summary>
    /// HTML 5 | Web Audio AudioWorkletNode output | Default on HTML5 if available
    /// </summary>
    AudioWorklet,
